...
Scenario: Verify Add a New sub section is enabled if option is selected
	Given user is on add doc page
...
Examples:
	...
	|feature|subSection|
	|Getting Started Again|SubSection2|
...
Examples:	
	...
	|Getting Started Again|SubSection2|To install MyApp,|To install MyApp, ensure your system meets the following requirements:|Scenario: Verify user is navigated to add documentation to the new feature form
...
Examples:	
	|feature|subSection|sub sub section|content|
	|Getting Started Again|SubSection2||To install MyApp, ensure your system meets the following requirements:|
	|Getting Started Again|SubSection2|To install MyApp,||
	|Getting Started Again|SubSection2|           |           |
	|Getting Started Again||||